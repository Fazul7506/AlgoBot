...
(() => {
  ...
  function bindSidebarScrollState(sidebar) {
    ...
    const recordScroll=()=>{lastKnownTop=Math.max(0,sidebar.scrollTop||0);savePosition();}; sidebar.addEventListener('scroll',recordScroll,{passive:true});
