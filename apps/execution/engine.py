...
class ExecutionEngine:
    ...
    def place_order(self, user, **data):
        """Handle an explicit user order command.

        Manual orders are never generated by a strategy scheduler. They are
        queued only after this explicit command has passed the normal risk and
        broker gates.
        """
