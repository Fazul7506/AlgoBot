...
class BrokerAccount(models.Model):
    ...
    created_at=models.DateTimeField(auto_now_add=True)
    class Meta: unique_together=[('broker','account_id')]; indexes=[models.Index(fields=['user','status']),models.Index(fields=['broker','is_preferred'])]
...
class BrokerConnection(models.Model):
    ...
    class Meta: indexes=[models.Index(fields=['broker','status']),models.Index(fields=['last_ping'])]
...
class Order(models.Model):
    ...
    class Meta: ordering=['-created_at']; indexes=[models.Index(fields=['user','status']),models.Index(fields=['broker','status'])]
...
class Position(models.Model):
    ...
    opened_at=models.DateTimeField(default=timezone.now); closed_at=models.DateTimeField(null=True, blank=True)
