...
class BrokerAccountSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model=BrokerAccount
        fields=['id','user','broker','broker_name','broker_account_id','account_id','account_type','avatar_url','display_name','branding','currency','balance','equity','margin','free_margin','net_profit_loss','status','is_default','is_active','is_connected','credential_status','last_synced_at','data_freshness','switch_enabled','created_at']
        read_only_fields=['user','balance','equity','margin','free_margin','net_profit_loss','last_synced_at','broker_account_id','account_type','avatar_url','display_name','branding','is_default','is_active','is_connected','data_freshness','switch_enabled']
