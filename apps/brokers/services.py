...
class BrokerRegistry:
    adapter_paths = {'deriv': 'apps.brokers.adapters.deriv.DerivAdapter', **{broker: f'apps.brokers.adapters.{broker}.Adapter' for broker in c.SCAFFOLD_BROKERS}}
