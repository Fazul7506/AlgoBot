...
BROKER_WS_URL = env("BROKER_WS_URL", env("DERIV_PUBLIC_WS_URL", "wss://api.derivws.com/trading/v1/options/ws/public"))
BROKER_OAUTH_CLIENT_ID = env("BROKER_OAUTH_CLIENT_ID", BROKER_APP_ID)
BROKER_REDIRECT_URI = env("BROKER_REDIRECT_URI", env("DERIV_REDIRECT_URI", ""))
