...
"apps.ai_engine", "apps.analysis",
"apps.automation", "apps.backtesting", "apps.brokers",
    "apps.contracts", "apps.copy_trading", "apps.deployment", "apps.developer",
"apps.enterprise", "apps.execution",
    "apps.feature_store", "apps.health", "apps.indicators", "apps.market_data",
