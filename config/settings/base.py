...
"apps.ai_engine", "apps.alerts", "apps.analysis",
"apps.automation", "apps.backtesting", "apps.brokers", "apps.community",
...
"apps.licensing", "apps.logging_system", "apps.market_data", "apps.marketplace",
"apps.monitoring", "apps.notifications", "apps.observability",
    "apps.optimization", "apps.organizations", "apps.paper_trading", "apps.portfolio", "apps.providers",
"apps.referrals", "apps.reports", "apps.risk", "apps.signals", "apps.simulation",
...
TEMPLATES = [{
    ...
    "OPTIONS": {"context_processors": [
        ...
        "core.context_processors.algobot_romantic_splash",
    ]},
}]
...
from config.settings.broker import *  # noqa: E402,F403
from config.settings.security import *  # noqa: E402,F403
from config.settings.logging import *  # noqa: E402,F403
from config.settings.celery import *  # noqa: E402,F403
from config.settings.payment import *  # noqa: E402,F403
