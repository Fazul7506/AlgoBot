...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['user', '-created_at'], name='core_invoic_user_id_5034e4_idx')],
            },
        ),
        migrations.CreateModel(
            name='Payment',
            ...
            options={
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['user', '-created_at'], name='core_paymen_user_id_1df83c_idx')],
            },
        ),
        migrations.CreateModel(
            name='ReferralReward',
