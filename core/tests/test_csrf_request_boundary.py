...
class CSRFRequestBoundaryTests(TestCase):
    def setUp(self):
        ...
        self.user = get_user_model().objects.create_user(username='csrf-boundary-user', password='test-pass')
    ...
    def test_cookie_authenticated_api_post_without_csrf_returns_machine_readable_error(self):
        self.assertTrue(self.client.login(username='csrf-boundary-user', password='test-pass'))
