...
app.conf.beat_schedule = {
    ...
    "candle-backfill-recovery-every-2-minutes": {"task": "apps.market_data.tasks.reconcile_candle_backfill_runs", "schedule": crontab(minute="*/2"), "kwargs": {"max_age_seconds": 300}},
