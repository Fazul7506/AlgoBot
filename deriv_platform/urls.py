...
urlpatterns = [
    ...
    path('', home, name='home'), path('login/', login_page, name='login_page'), path('register/', register_page, name='register_page'),
    ...
    path('dashboard/', dashboard_page, name='dashboard_page'), path('saas/', login_required(lambda request: render(request, 'saas/control_center.html')), name='saas_control_center'), path('copy-trading/', login_required(lambda request: render(request, 'copy_trading/control_center.html')), name='copy_trading_control_center'),
    ...
    # Canonical broker account/auth endpoints come before the legacy execution layer so OAuth-created accounts are addressable.
    path('api/', include('apps.broker.urls')), path('api/', include('apps.brokers.urls')),
    path('api/', include('apps.market_data.urls')), path('api/', include('apps.indicators.urls')), path('api/', include('apps.execution.urls')), path('api/', include('apps.risk.urls')), path('api/', include('apps.strategies.urls')), path('api/', include('apps.smart_money.urls')), path('api/', include('apps.backtesting.urls')), path('api/', include('apps.ai_engine.urls')), path('api/', include('apps.monitoring.urls')), path('api/', include('apps.portfolio.urls')), path('api/', include('apps.automation.urls')), path('api/', include('apps.notifications.urls')), path('developer/', include(('apps.developer.urls', 'developer_ui'), namespace='developer_ui')), path('api/developer/', include('apps.developer.urls')), path('api/system/', include('apps.deployment.urls')), path('api/enterprise/', include('apps.enterprise.urls')), path('health/', include('apps.health.urls')),
